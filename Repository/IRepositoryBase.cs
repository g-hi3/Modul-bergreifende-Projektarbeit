...
namespace Repository
{
    public interface IRepositoryBase<M> {
        ...
        /// <summary>
        /// Gibt eine Liste von Model-Objekten vom Typ M zurück, die gemäss der WhereBedingung geladen wurden. Die
        /// Werte der Where-Bedingung können als separat übergeben werden, damit diese für PreparedStatements verwendet
        /// werden können. (Verhinderung von SQL-Injection)
        /// </summary>
        /// <param name="whereCondition">WhereBedingung als string z.B. "NetPrice > @netPrice and Active = @active and
        /// Description like @desc</param>
        /// <param name="parameterValues">Parameter-Werte für die Wherebedingung bspw:
        /// {{"netPrice", 10.5}, {"active", true}, {"desc", "Wolle%"}}</param>
        /// <returns></returns>
        ...
        List<M> GetAll();
        /// <summary>
        /// Zählt in der Datenbank die Anzahl Model-Objekte vom Typ M, die der Where-Bedingung entsprechen
        /// </summary>
